...
public class PermissionDispatcherDetector extends Detector implements Detector.JavaScanner {
    public static final Issue ISSUE = Issue.create("CallNeedsPermission", "A method annotated with @NeedsPermission should not be call directly", "A method annotated with @NeedsPermission should not be call directly", Category.CORRECTNESS, 7, Severity.ERROR, new Implementation(PermissionDispatcherDetector.class, EnumSet.of(Scope.ALL_JAVA_FILES)));
    ...
    private static class AnnotationChecker extends ForwardingAstVisitor {
        ...
        public boolean visitAnnotation(Annotation node) {
            ...
            if (resolvedNode instanceof JavaParser.ResolvedClass) {
                ...
                context.requestRepeat(new PermissionDispatcherDetector(), EnumSet.of(Scope.ALL_JAVA_FILES));
            }
            return super.visitAnnotation(node);
        }
    }
    ...
    private class MethodCallChecker extends ForwardingAstVisitor {
        ...
        public boolean visitMethodInvocation(MethodInvocation node) {
            ...
            JavaParser.ResolvedAnnotation annotation = method.getAnnotation(NeedsPermission.class.getSimpleName());
            if (annotation == null) {
                return super.visitMethodInvocation(node);
            }
