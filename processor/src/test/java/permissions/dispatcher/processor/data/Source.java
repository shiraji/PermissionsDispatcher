    ...
    public static final BaseTest OnePermissionWithParametersAndDeniedActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       switch (requestCode) {",
                    "           case REQUEST_SHOWCAMERA:",
                    "               if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && !PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA)) {",
                    "                   target.cameraDenied();",
                    "                   return;",
                    "               }",
                    "               if (PermissionUtils.verifyPermissions(grantResults)) {",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureAndDeniedActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "               break;",
                    "           case REQUEST_SHOWCAMERA2:",
                    "               if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && !PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA2)) {",
                    "                   target.cameraDenied();",
                    "                   return;",
                    "               }",
                    "               if (PermissionUtils.verifyPermissions(grantResults)) {",
    ...
    public static final BaseTest OnePermissionWithNeverAskRationaleAndDeniedSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "       switch (requestCode) {",
                    "           case REQUEST_SHOWCAMERA:",
                    "               if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && !PermissionUtils.hasSelfPermissions(target.getActivity(), PERMISSION_SHOWCAMERA)) {",
                    "                   target.cameraDenied();",
                    "                   return;",
                    "               }",
                    "               if (PermissionUtils.verifyPermissions(grantResults)) {",
    ...
    public static final BaseTest TwoPermissionsWithSameSignatureAndDeniedSupportFragment = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "               break;",
                    "           case REQUEST_SHOWCAMERA2:",
                    "               if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && !PermissionUtils.hasSelfPermissions(target.getActivity(), PERMISSION_SHOWCAMERA2)) {",
                    "                   target.cameraDenied();",
                    "                   return;",
                    "               }",
                    "               if (PermissionUtils.verifyPermissions(grantResults)) {",
    ...
    public static final BaseTest NoDuplicatesDespiteRepeatedValuesActivity = new BaseTest() {
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "               if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && !PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWGETSTORAGE)) {",
