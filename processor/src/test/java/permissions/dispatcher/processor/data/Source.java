...
public final class Source {
    ...
    public static final BaseTest OnePermissionWithGenericsActivity = new BaseTest() {
        @Override
        protected String getName() {
            return "MyActivity";
        }
        ...
        protected String[] getExpectSource() {
            return new String[]{
                    ...
                    "  }",
                    "",
                    "  static <T, U extends Integer, V extends Map<? extends Annotation, ?>> void showCameraWithCheck(MyActivity<T, U, V> target) {",
                    "    if (PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA)) {",
                    "      target.showCamera();",
                    "    } else {",
                    "      if (PermissionUtils.shouldShowRequestPermissionRationale(target, PERMISSION_SHOWCAMERA)) {",
                    ...
                    "  }",
                    "",
                    "  static <T, U extends Integer, V extends Map<? extends Annotation, ?>> void onRequestPermissionsResult(MyActivity<T, U, V> target, int requestCode, int[] grantResults) {",
                    "    switch (requestCode) {",
                    "      case REQUEST_SHOWCAMERA:",
                    "      if (PermissionUtils.getTargetSdkVersion(target) < 23 && !PermissionUtils.hasSelfPermissions(target, PERMISSION_SHOWCAMERA)) {",
                    "        target.cameraDenied();",
                    ...
                    "",
                    "    private ShowCameraPermissionRequest(MyActivity<T, U, V> target) {",
                    "      this.weakTarget = new WeakReference<>(target);",
                    "    }",
                    "",
                    "    @Override",
